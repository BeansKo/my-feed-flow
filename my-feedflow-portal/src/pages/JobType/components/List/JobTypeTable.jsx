...
export default class JobTypeTable extends Component {
    static displayName = 'JobTypeTable';
    ...
    renderStep = (jobStep) => {
      return jobStep ? <pre style={{margin:"0px"}}>{jobStep.join("\n")}</pre> : ""
    }
        ...
        <div className="simple-table">
          <IceContainer>
            <Table dataSource={this.state.pageData} isLoading={this.state.loading} className="basic-table" hasBorder={false} locale={{empty:"no data"}}>
              ...
              <Table.Column title="Job Step" dataIndex="jobStep" width={80} cell={this.renderStep}/>
              <Table.Column title="Options" dataIndex="operation" width={30} cell={this.renderOperations}/>
            </Table>
